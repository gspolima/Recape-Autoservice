...
namespace Recape.Data.Migrations
{
    ...
    [Migration("20211208160818_Tornar_Proprietario_Obrigatorio")]
    partial class Tornar_Proprietario_Obrigatorio
    {
            ...
            modelBuilder.Entity("Recape.Models.Servico", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Nome = "Troca de Óleo",
                            TempoDeExecucao = new TimeSpan(0, 2, 0, 0, 0),
                            Valor = 249.99m
                        },
                        new
                        {
                            Id = 2,
                            Nome = "Alinhamento",
                            TempoDeExecucao = new TimeSpan(0, 8, 0, 0, 0),
                            Valor = 129.99m
                        },
                        new
                        {
                            Id = 3,
                            Nome = "Funilaria",
                            TempoDeExecucao = new TimeSpan(2, 12, 0, 0, 0),
                            Valor = 199.99m
                        },
                        new
                        {
                            Id = 4,
                            Nome = "Pintura",
                            TempoDeExecucao = new TimeSpan(3, 0, 0, 0, 0),
                            Valor = 179.99m
                        },
                        new
                        {
                            ...
                            TempoDeExecucao = new TimeSpan(5, 0, 0, 0, 0),
                            Valor = 309.99m
                        });
                });
